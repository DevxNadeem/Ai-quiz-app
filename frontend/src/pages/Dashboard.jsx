...
function Dashboard() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log(data.quiz._id);
      navigate(`/quiz/${data.quiz._id}/info`);
    } catch {
      ...
      <div className="w-full max-w-lg mx-auto">
        ...
        <div className="flex items-center gap-2 mb-10">
          ...
          <span
            ...
            style={{ color: "#14142B", letterSpacing: "-0.01em" }}
          >
            Recall
          </span>
        </div>
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              "0 1px 2px rgba(20,20,43,0.04), 0 12px 32px rgba(20,20,43,0.06)",
          }}
        >
          <div className="mb-8">
            <p
            ...
            <p className="mt-2 text-sm" style={{ color: "#77748C" }}>
              Pick a topic, set the difficulty, and Recall builds the
              questions.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {error && (
              <p
                ...
                style={{ backgroundColor: "#FDEEEE", color: "#B3261E" }}
              >
                {error}
              </p>
            )}
        ...
        <div className="mt-10">
          ...
          {loadingQuizzes ? (
            ...
            >
              ...
              >
                <span className="font-serif text-xl" style={{ color: "#4C4FE0" }}>
                  ?
                </span>
              </div>
              <h3
              ...
              <p className="text-sm" style={{ color: "#77748C" }}>
                Generate your first quiz above — it'll show up here with
                analysis once you complete it.
              </p>
            </div>
          ) : (
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          setExpandedId(isOpen ? null : quiz.id)
                        }
                    ...
                    {isOpen && (
                      ...
                      >
                        <div className="grid grid-cols-3 gap-3 text-center font-mono">
                          <div>
                            <p className="text-xl" style={{ color: "#14142B" }}>
                              {quiz.score ?? "—"}
                            </p>
                            <p className="text-xs mt-1" style={{ color: "#77748C" }}>
                              Score
                            </p>
                          </div>
                          <div>
